...
int endScreen::Run(sf::RenderWindow &App) {
	...
	sf::SoundBuffer Death2, ExitSelectSound;
	sf::Sound DeathSound2, ExitSelect;
	Death2.loadFromFile("DEATHNOISE2.wav");
	ExitSelectSound.loadFromFile("ExitSound.wav");
	ExitSelect.setBuffer(ExitSelectSound);


	DeathSound2.setBuffer(Death2);
	...
	GameOverImage.loadFromFile("YouDied.png");
