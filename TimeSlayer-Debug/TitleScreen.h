...
int title::Run(sf::RenderWindow &App)
{
	...
	sf::Sound PlaySelect;
    sf::Sound ExitSelect;
	sf::SoundBuffer PlayselectSound;
    sf::SoundBuffer ExitSelectSound;
	/*sf::SoundBuffer PlayMenu;*/
	PlayselectSound.loadFromFile("PlaySelect1.wav");
	ExitSelectSound.loadFromFile("ExitSound.wav");
	MenuMusic.openFromFile("MenuMusic.wav");

	PlaySelect.setBuffer(PlayselectSound);
	...
	sf::Sprite Sprite, bimage,DeathScreen1;
	//ddeath
	titleScreenImage.loadFromFile("TitleScreen.png");
	bimage.setTexture(titleScreenImage);
	bimage.setScale(1366 / bimage.getLocalBounds().width, 768 / bimage.getLocalBounds().height);
